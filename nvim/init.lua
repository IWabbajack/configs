  ...
  require 'nvim-treesitter.configs'.setup {
    ...
    incremental_selection = {
      ...
      keymaps = {
        ...
        -- TODO: find a fucking binding here.
        -- MacOS is complete garbage, M maps to their retarder "command" bullshit
        -- Who the fuck uses that retarder key?
...
-- TODO: This uses tmux to switch sessions. Learn how to use it
-- vim.keymap.set("n", "Q", "<nop>")
-- vim.keymap.set("n", "<C-f>", "<cmd>silent !tmux neww tmux-sessionizer<CR>")
-- vim.keymap.set("n", "<leader>f", vim.lsp.buf.format)

-- TODO: this is quick fix navigation
